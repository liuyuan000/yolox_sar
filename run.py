...
def image_demo(predictor, vis_folder, path, current_time, save_result, save_xml):
    ...
    for image_name in files:
        if(image_name[-3:]!="tif"):
            continue
        with open(save_xml + "/" + image_name.split("/")[-1].split(".")[0] + ".xml", "w") as f:
            print(save_xml + "/" + image_name.split("/")[-1].split(".")[0] + ".xml", "write")
...
def main():
    ...
    image_demo(predictor, vis_folder, args.path1, current_time, args.save_result, args.path2)
